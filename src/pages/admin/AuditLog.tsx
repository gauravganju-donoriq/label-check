...
export default function AuditLog() {
  ...
  function getActionIcon(action: string) {
    switch (action) {
      ...
      case 'deactivated':
        return <Power className="w-4 h-4 text-orange-500" />;
      case 'reactivated':
  ...
  function getActionBadge(action: string) {
    switch (action) {
      ...
      case 'deactivated':
        return <Badge className="bg-orange-500">Deactivated</Badge>;
      case 'reactivated':
        return <Badge className="bg-green-500">Reactivated</Badge>;
      case 'deleted':
  ...
  return (
    <AppLayout>
      <div className="space-y-6">
        <div>
          <h1 className="text-2xl font-bold">Rule Audit Log</h1>
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <div className="flex items-center gap-2">
                          ...
                          <span className="font-medium">{getRuleName(log)}</span>
                          {log.states && (
          ...
          {selectedLog && (
            <div className="space-y-4">
              <div className="grid grid-cols-2 gap-4 text-sm">
                ...
                <div>
                  <span className="text-muted-foreground">From Suggestion:</span>
